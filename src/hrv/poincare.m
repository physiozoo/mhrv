...
DEFAULT_RR_MIN = rhrv_get_default('poincare.rr_min', 'value');
DEFAULT_RR_MAX = rhrv_get_default('poincare.rr_max', 'value');
DEFAULT_RR_MAX_CHANGE = rhrv_get_default('poincare.rr_max_change', 'value');

...
% data well).
DEFAULT_SD1_FACTOR = rhrv_get_default('poincare.sd1_factor', 2);
DEFAULT_SD2_FACTOR = rhrv_get_default('poincare.sd2_factor', 2);
DEFAULT_RR_MIN = rhrv_get_default('poincare.rr_min', 0.32); % Seconds (187.5 BPM)
DEFAULT_RR_MAX = rhrv_get_default('poincare.rr_max', 1.5);  % Seconds (40 BPM)
DEFAULT_RR_MAX_CHANGE = rhrv_get_default('poincare.rr_max_change', 25); % Percent, max change between adjacent RR intervals

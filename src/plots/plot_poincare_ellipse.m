...
plot(ax, plot_data.x_orig(plot_data.filter_idx_pp), plot_data.y_orig(plot_data.filter_idx_pp), 'ro', 'MarkerSize', msz*1.25);
plot(ax, plot_data.ellipse_old(1,:), plot_data.ellipse_old(2,:), 'k--', 'LineWidth', lw_ellipse);
plot(ax, plot_data.sd1_line_old(1,:), plot_data.sd1_line_old(2,:), 'r-', 'LineWidth', lw_sdline);
plot(ax, plot_data.sd2_line_old(1,:), plot_data.sd2_line_old(2,:), 'g-', 'LineWidth', lw_sdline);
legend(ax, {'RR intervals', 'Outliers', 'Ellipse fit', sprintf('SD1=%.4f', plot_data.sd1), sprintf('SD2=%.4f', plot_data.sd2)}, 'Location', 'southeast');
